...
- <b>Microsoft Azure</b>
  ...
  - [Observing Network Traffic and Network Security Groups (NSGs) Functions](https://github.com/mxwllslvr/observing-network-traffic-and-network-security-groups-NSGs-functions) (In Progress)
